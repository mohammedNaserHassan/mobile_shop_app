...
import 'package:mobile_shop_app/View/TabScreens/Profile/Action/ProfileScreen.dart';
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Container(
                          margin:
                              EdgeInsets.only(left: 2.w, right: 15.w, top: 1.h),
                          height: 70.h,
                          width: 60.w,
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10.r),
                          ...
                          child: FadeInImage.assetNetwork(
                            ...
                            image: provider.profileModel.data?.image ??
                ...
                ListView.builder(
                  ...
                  itemCount: provider.settings.length,
                    itemBuilder: (context, index) =>
                        profileTile(settings: provider.settings[index]))
              ],
            );
          },
        ),
